					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						<div className="group relative p-8 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.05] backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
							...
							<div className="relative space-y-4">
								...
								<p className="text-muted-foreground">
									Online staj başvurusu yapın ve başvuru durumunuzu
									takip edin
								</p>
							</div>
						</div>
						...
						<div className="group relative p-8 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.05] backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
							...
							<div className="relative space-y-4">
								...
								<p className="text-muted-foreground">
									Staj günlüğünüzü dijital ortamda tutun ve geri
									bildirim alın
								</p>
							</div>
						</div>
						...
						<div className="group relative p-8 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.05] backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
							...
							<div className="relative space-y-4">
								...
								<p className="text-muted-foreground">
									Öğrencilerin staj süreçlerini ve aktivitelerini
									kolayca yönetin
								</p>
							</div>
						</div>
						...
						<div className="group relative p-8 rounded-2xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.05] backdrop-blur-sm transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
							...
							<div className="relative space-y-4">
								...
								<p className="text-muted-foreground">
									Başvuru ve aktivite onaylarını hızlıca
									gerçekleştirin
								</p>
							</div>
						</div>

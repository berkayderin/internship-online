...
const RegisterPage = () => {
  ...
  const handleRegister = async (data) => {
    try {
      ...
      toast({
        title: 'Hata',
        description: error.message || 'Kayıt oluşturulamadı. Lütfen tekrar deneyin.',
        variant: 'destructive',
      });
    }
  };
      ...
      <div className="relative w-full max-w-[520px]">
        ...
        <div className="relative space-y-6 p-8">
          <div className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground">Staj takip sistemine kayıt olun</p>
          </div>

          <AuthForm type="register" onSubmit={handleRegister} isSubmitting={register.isLoading} schema={registerSchema} />
        </div>
      </div>

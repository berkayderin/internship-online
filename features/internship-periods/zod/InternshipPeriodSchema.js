...
const internshipPeriodSchema = z
	...
	.refine((data) => data.endDate > data.startDate, {
		message:
			'Başvuru bitiş tarihi başlangıç tarihinden sonra olmalıdır',
		path: ['endDate']
	})
	.refine(
		...
		{
			message:
				'Staj bitiş tarihi başlangıç tarihinden sonra olmalıdır',
			path: ['internshipEndDate']
		}
	)
	.refine((data) => data.internshipStartDate > data.endDate, {
		message:
			'Staj başlangıç tarihi başvuru bitiş tarihinden sonra olmalıdır',

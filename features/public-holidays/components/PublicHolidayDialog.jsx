...
export function PublicHolidayDialog({ mode, holiday, open, onOpenChange }) {
      ...
      <DialogContent>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <DatePickerField control={form.control} name="startDate" label="Başlangıç Tarihi" />
            <DatePickerField control={form.control} name="endDate" label="Bitiş Tarihi" />
